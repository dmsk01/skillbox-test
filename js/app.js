(() => {
    ...
    const searchButtonOpen = document.querySelector(".search-header__btn_open");
    const searchInput = document.querySelector(".search-header__input");
    const searchButtonClose = document.querySelector(".search-header__btn_close");
    const searchForm = document.querySelector(".search-header");
    if (searchButtonOpen) searchButtonOpen.addEventListener("click", (() => {
        searchForm.classList.add("active");
        searchInput.focus();
    }));
    if (searchButtonClose) searchButtonClose.addEventListener("click", (() => {
        searchForm.classList.remove("active");
    }));
